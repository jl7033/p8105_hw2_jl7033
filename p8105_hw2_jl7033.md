...
```
    ...
    ## # ℹ 4,260 more rows
    ## # ℹ 5 more variables: entry <lgl>, vending <chr>, ada <lgl>,
...
```
    ...
    ## # A tibble: 17 × 4
    ##    line             station_name                  route ada  
    ##    <chr>            <chr>                         <chr> <lgl>
    ##  1 8 Avenue         14th St                       A     TRUE 
    ##  2 8 Avenue         168th St - Washington Heights A     TRUE 
    ##  3 8 Avenue         175th St                      A     TRUE 
    ##  4 8 Avenue         34th St                       A     TRUE 
    ##  5 8 Avenue         42nd St                       A     TRUE 
    ##  6 8 Avenue         59th St                       A     TRUE 
    ##  7 8 Avenue         Inwood - 207th St             A     TRUE 
    ##  8 8 Avenue         West 4th St                   A     TRUE 
    ##  9 8 Avenue         World Trade Center            A     TRUE 
    ## 10 Broadway         Times Square-42nd St          A     TRUE 
    ## 11 Broadway-7th Ave 59th St-Columbus Circle       A     TRUE 
    ## 12 Broadway-7th Ave Times Square                  A     TRUE 
    ## 13 Canarsie         8th Av                        A     TRUE 
    ## 14 Franklin         Franklin Av                   A     TRUE 
    ## 15 Fulton           Euclid Av                     A     TRUE 
    ## 16 Fulton           Franklin Av                   A     TRUE 
    ## 17 Rockaway         Howard Beach                  A     TRUE
